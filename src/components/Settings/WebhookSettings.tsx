        ...
        <div className="mb-4 p-4 bg-gray-50 rounded-lg space-y-3">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-4 py-1.5 bg-brand-600 text-white text-sm rounded-lg hover:bg-brand-700 disabled:opacity-50"
            >
              Create
            </button>
          </div>
                  ...
                  <div className="flex items-center gap-2 mt-1 flex-wrap">
                    ...
                    {ep.last_triggered && (
                      <span className="text-[10px] text-gray-400 flex items-center gap-0.5">
                        ...
                        Last: {ep.last_status} ({new Date(ep.last_triggered).toLocaleDateString()})
                      </span>
                    )}
                    {ep.has_secret && (
